	...
	data(appId, newAppId, personalAppId) {
		...
		return {
			...
			'创建推送': [
				...
				{ 'id': 'createPush', 'code': '1002', 'name': '分组推送', 'to': '/create/push/?pushType=group&appId=' + newAppId, 'type': '创建推送' },
				{ 'id': 'createPush', 'code': '1003', 'name': '定时任务', 'to': '/create/push/?pushType=timing&appId=' + newAppId, 'type': '创建推送' },
				{ 'id': 'createPush', 'code': '1004', 'name': '桌面通知', 'to': '/create/push/?pushType=desktop&appId=' + newAppId, 'type': '创建推送' }
			],
			'数据统计': [
			...
			'配置管理': [
				...
				{ 'id': 'configManage', 'code': '3004', 'name': '回执管理', 'to': '/config/callback?appId=' + newAppId, 'type': '配置管理' }
			],
			'个性化推送': [
			...
			'平台管理': [
				{ 'id': 'platformManage', 'code': '6000', 'to': '/platform/app/list', 'name': '应用列表', 'type': '平台管理' },
				{ 'id': 'platformManage', 'code': '6001', 'to': '/platform/data', 'name': '平台数据', 'type': '平台管理' },
				{ 'id': 'platformManage', 'code': '6002', 'to': '/platform/module/config', 'name': '模块配置', 'type': '平台管理' },
				{ 'id': 'platformManage', 'code': '6003', 'to': '/platform/user/group/config', 'name': '用户群配置', 'type': '平台管理' }
			],
			'账号管理': [
				{ 'id': '', 'code': '6000', 'to': '/account/role', 'name': '角色管理', 'type': '账号管理' },
				{ 'id': '', 'code': '6001', 'to': '/account/manage', 'name': '账号管理', 'type': '账号管理' },
				{ 'id': '', 'code': '6002', 'to': '/account/module', 'name': '模块权限配置', 'type': '账号管理' },
				{ 'id': '', 'code': '6003', 'to': '/account/app/auth', 'name': '应用权限组配置', 'type': '账号管理' }
			] 
		};
	}
};
