/*
 * @Author: ecofe 
 * @Date: 2018-06-29 15:55:30 
 * @Last Modified by:   ecofe 
 * @Last Modified time: 2018-06-29 15:55:30 
 */
'use strict'
  ...
  render() {
    const data = [
      ...
      },
      {
        text: '短信推送手机号白名单',
        title:
          '开启白名单后，短信推送的手机号推送功能目标用户将不过滤应用订阅关系'
      },
      {
        text: '目标数',
        title: '计划推送的目标数'
      ...
      },
      {
        text: '到达应用数',
        title:
          'PushSDK将消息发送给应用的数量（Flyme6中，通知栏消息由pushSDK弹出，此埋点仍保留有上报数据）'
      },
      {
        text: '划掉数',
      ...
      },
      {
        text: '点击数',
        title:
          '用户点击消息的数量（3.0以下版本SDK，数据统计T+1，3.0以上实时统计。透传消息没有点击数统计）'
      },
      {
        text: '收纳数',
        title:
          '通知栏消息被收进收纳盒的数量。（覆盖2017年5月份后发布的Flyme6固件用户）'
      },
      {
        text: '不展示数',
        title:
          '用户设置“不允许通知”的数量，消息不会展示在通知栏上。（覆盖2017年5月份后发布的Flyme6固件用户）'
      },
      {
        text: 'App ID',
      ...
      },
      {
        text: '定速推送',
        title:
          '开启定速推送后，此任务的推送速率将按设置的速率推送。速率不会超过应用最大推送速率'
      },
      {
        text: '定时展示',
      ...
      },
      {
        text: '小图标',
        title:
          '小图标会出现在标题前面，占用部分的展示面积。可选择默认的图标类型，也可自定义上传，自定义图标的大小为24*24'
      },
      {
        text: '推送量',
      ...
      },
      {
        text: '功能转化率',
        title:
          '统计个性化推送、图片推送的转化率。衡量高级推送功能与普通常规推送的对比。计算公式：点击数/（展示数-不展示数）'
      },
      {
        text: '点击转化率',
        title:
      ...
      },
      {
        text: '消息去重',
        title:
          '分组推送内的消息去重可能会出现子任务的推送用户量少于目标用户量的情况'
      },
      {
        text: '每天推送限制',
      ...
      },
      {
        text: '允许推送其他包名',
        title:
          '开启后，允许本应用带上第三方应用包名，点击通知栏后调起第三方应用'
      },
      {
      ...
      },
      {
        text: '应用推送消息总量（条/天）',
        title:
          '本应用可推送的消息总量，包含通知栏、透传、平台任务，API接口调用等所有方式'
      },
      {
        text: '绿色通道',
      ...
      },
      {
        text: '任务备注',
        title:
          '任务备注用于标记推送任务的业务类型与备注信息，方便后续推送数据的整理归类'
      }
    ]
